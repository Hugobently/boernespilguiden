  ...
  },
{
    ...
    cons: ["Engangspris", "Kan blive ensformigt over tid"],
  ...
  },
  {
    ...
    cons: ["Kræver abonnement", "Begrænset antal ingredienser"],
  ...
  },
{
  ...
  },
  {
    ...
    parentTip: "Gratisversionen har masser af indhold - prøv den før du køber tilføjelser.",
    featured: false,
    editorChoice: false,
  },
  {
    ...
    parentTip: "Velegnet til Bluey-fans! De 2 gratis områder er gode til at starte med.",
    featured: true,
    editorChoice: false,
  },
  {
    ...
    parentTip: "Budge Studios laver sikre apps - velegnet til PAW Patrol-fans!",
    featured: false,
    editorChoice: false,
  },
  {
  ...
  },
  {
    ...
    pros: ["Ingen reklamer", "Ingen in-app-køb", "Virker offline", "Velegnet til babyer", "Simpelt design"],
...
export const games3to6: GameSeedData[] = [
  {
    ...
    pros: ["Helt gratis - ingen skjulte omkostninger", "Ingen reklamer", "Ingen in-app-køb", "Virker offline", "Tilpasser sig barnets niveau", "Nonprofitorganisation"],
  ...
  },
  {
    ...
    shortDescription: "Skab dine egne historier i en uendelig legeverden",
    minAge: 3,
    maxAge: 12,
    ageGroup: "3-6",
    ...
    cons: ["Mange in-app-køb", "Kan blive dyrt at købe alt", "Butikken fylder meget i spillet"],
  ...
  },
  {
    ...
    cons: ["Engangspris", "Kort spilletid", "Kan være for svært for de yngste"],
  ...
  },
  {
    ...
    parentTip: "Prøv den gratis prøveperiode - denne app er ofte anbefalet af børnepsykologer.",
    featured: true,
    editorChoice: true,
  },
  {
  ...
  },
{
  ...
  },
  {
    ...
    slug: "dr-oeen",
    description: "På Ramasjang Ø venter et helt lille land fyldt med spil, leg og aktiviteter, som barnet frit kan gå på opdagelse i sammen med sine yndlingsfigurer fra Ramasjang. I stedet for faste baner udforsker barnet øen i sit eget tempo, finder nye steder og prøver de lege, der dukker op undervejs, og det træner både nysgerrighed, navigation og problemløsning gennem fri, ustruktureret leg. Universet er stort og flot lavet med dansk tale, og som DR's andre apps er den helt gratis uden reklamer og in-app-køb; nyt indhold og opdateringer koster heller aldrig noget. Den åbne struktur kan dog virke lidt forvirrende for de mindste, som ikke altid ved, hvad de skal. Bedst til børn på 4-8 år, der elsker selv at bestemme, hvor legen skal bevæge sig hen.",
  ...
  },
  {
    ...
    parentTip: "Velegnet til børn der elsker biler - kombiner med legetøjsbiler for endnu mere leg!",
    featured: false,
    editorChoice: false,
  },
  {
  ...
  },
{
  ...
  },
  {
    ...
    cons: ["Engangspris", "Begrænset indhold"],
    parentTip: "Snak med barnet om, hvad det finder - det styrker sproget og observationsevnen.",
    featured: false,
    editorChoice: false,
  },
  {
...
export const games7to10: GameSeedData[] = [
  ...
  },
  {
    ...
    shortDescription: "Lær USA's geografi gennem stabling",
    minAge: 6,
    maxAge: 12,
    ageGroup: "7+",
    ...
    pros: ["Ingen reklamer", "Ingen in-app-køb", "Virker offline", "Sjovt og lærerigt"],
    cons: ["Fokus på USA", "Mindre relevant for danske børn"],
    parentTip: "God til at lære amerikansk geografi - men der findes også Stack the Countries til verdensgeografi.",
    featured: false,
    editorChoice: false,
  },
  {
    title: "Prodigy Math",
    slug: "prodigy-math",
    description: "Matematiktræning pakket ind i et magisk rollespil — sådan fungerer Prodigy Math, hvor barnet skaber sin egen troldmand og kæmper mod monstre ved at løse regneopgaver. Hver kamp kræver rigtige svar, og opgaverne tilpasser sig automatisk barnets niveau, så både den øvede og den, der er usikker i matematik, kan være med. Undervejs trænes matematik, problemløsning og strategi, og belønningerne holder motivationen oppe. Spillet bruges i mange skoler, al matematikken er gratis, og der er ingen reklamer. Til gengæld kræver det internetforbindelse, og der lokkes med kosmetiske køb undervejs — slå eventuelt køb fra på enheden. Vær også opmærksom på, at nogle børn fokuserer mere på selve spillet end på læringen. Bedst til børn mellem 6 og 14 år, der skal have lidt ekstra lyst til tallene.",
    ...
    cons: ["In-app-køb af kosmetisk indhold", "Kræver internet", "Kan fokusere mere på spil end læring"],
    parentTip: "Matematik er gratis - kun kosmetisk indhold koster penge. Deaktiver køb for at undgå fristelser.",
    featured: true,
    editorChoice: false,
  },
  {
  ...
  },
  {
    ...
    pros: ["Ingen reklamer", "Ingen in-app-køb", "Virker offline", "Unik gameplay", "Kunstnerisk mesterværk"],
  ...
  },
  {
    ...
    parentTip: "Brug forældrepanelet til at se hvad barnet har svært ved og hjælp det dér.",
    featured: false,
    editorChoice: false,
  },
  // ============================================
  ...
  },
  {
    "title": "WHAT THE CAR?",
    "slug": "what-the-car",
    "description": "Fra det københavnske studie Triband – holdet bag WHAT THE GOLF? – kommer dette absurde komedie-'racerspil', hvor bilen konstant forvandler sig: en bil med ben, en bil der er en slange, en bil spændt fast til en raket. Hundredvis af korte slapstick-baner fungerer som små fysikeksperimenter, hvor det at fejle er en indbygget del af morskaben, og netop derfor opbygger spillet eksperimenteringslyst og gåpåmod frem for konkurrencementalitet. Styringen klares med én finger på iPhone og iPad, og humoren er rent visuel, så engelskkundskaber er overflødige. Kvaliteten er anerkendt med en Apple Design Award, og Steam-versionen fra 2024 tilføjede nyt indhold. Læringsdybden er til gengæld beskeden – ud over fysikintuition er det mest velproduceret fjolleri – og på iOS kræver spillet et Apple Arcade-abonnement. Til børn fra 7 år, der elsker at grine, også ad deres egne fejl.",
...
export const games11to15: GameSeedData[] = [
  ...
  },
  {
    ...
    parentTip: "NASA anbefaler dette spil! Velegnet til rum-interesserede børn.",
    featured: false,
    editorChoice: true,
  },
  {
    ...
    developerName: "Valve",
    pros: ["Ingen reklamer", "Ingen in-app-køb", "Virker offline", "Genialt design", "Sjov historie"],
  ...
  },
  {
    ...
    parentTip: "Velegnet til logisk tænkende børn - men sæt grænser, for dette spil kan æde timer!",
    featured: false,
    editorChoice: false,
  },
  {
  ...
  },
  {
    ...
    parentTip: "Prøv den gratis prøveperiode først for at se om barnet kan lide det, før du abonnerer.",
    featured: true,
    editorChoice: false,
  },
  {
  ...
  },
  {
    ...
    parentTip: "Godt supplement til skoleundervisning - følger et struktureret pensum, men indholdet er på engelsk.",
    featured: false,
    editorChoice: false,
  },
  {
  ...
  },
  {
    ...
    shortDescription: "Virtuel læringsverden for tweens",
    minAge: 8,
    maxAge: 13,
    ageGroup: "7+",
    ...
    cons: ["Kræver abonnement", "Kræver internet", "Kan være distraherende"],
...
export const appleArcadeGames: GameSeedData[] = [
  {
    ...
    shortDescription: "Lev livet som en nysgerrig Sasquatch i dette charmerende open-world-eventyr",
    minAge: 4,
    maxAge: 99,
    ageGroup: "3-6",
  ...
  },
  {
    ...
    parentTip: "Prøv lokal multiplayer-tilstand hvor hele familien kan spille sammen.",
    featured: false,
    editorChoice: false,
  },
  {
